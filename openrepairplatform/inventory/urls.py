...
urlpatterns = [
    ...
    path(
        "device/<int:pk>/<slug>/", views.DeviceDetailView.as_view(), name="device_view"
    ),
    path("", views.StockListView.as_view(), name="stock_list"),
    path("stuff/<int:stuff_pk>/", views.StuffDetailView.as_view(), name="stuff_view"),
    path(
    ...
    path(
        "update_stuff/<int:pk>/", views.StuffUpdateView.as_view(), name="update_stuff"
    ),
    path(
